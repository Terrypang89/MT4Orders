// Внесены МИНИМАЛЬНЫЕ изменения, чтобы компилировался в MQL4 под #property strict, original - https://www.mql5.com/ru/code/8126

string time1, time2;   // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
double price1, price2; // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
int i;                 // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
...
void deinit(){
  FileClose(h1);
  Alert("Done.");
  return; // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
}
...
void Sort() {
  if (ArraySize(SortBy) == 0) return; // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
...
int Compare(int ticket1, int ticket2) {
  ...
  for (int i=0; i < size; i++) {
    ...
    if (SortBy[i] == BY_TICKET) {
      ...
      time1 = TimeToStr(OrderOpenTime()); // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
      OrderSelect(ticket2, SELECT_BY_TICKET, MODE_HISTORY);
      time2 = TimeToStr(OrderOpenTime()); // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
      ...
      OrderSelect(ticket1, SELECT_BY_TICKET, MODE_HISTORY);
      price1 = OrderOpenPrice(); // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
      OrderSelect(ticket2, SELECT_BY_TICKET, MODE_HISTORY);
      price2 = OrderOpenPrice(); // #property strict (MQL5), original - https://www.mql5.com/ru/code/8126
