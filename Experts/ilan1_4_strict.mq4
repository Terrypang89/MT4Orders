// ¬несены ћ»Ќ»ћјЋ№Ќџ≈ изменени€, чтобы компилировалс€ в MQL4 под #property strict, original - https://www.mql5.com/ru/code/8492
...
extern double  LotExponent=1.667; // умножение лотов в серии по експоненте дл€ вывода в безубыток. первый лот 0.1, сери€: 0.16, 0.26, 0.43 ...
   ...
   double tLots;
     switch(MMType)
     {
         ...
         case 1:
            ...
            break;
         case 2:
           {int LastClosedTime=0; // #property strict (MQL5), original - https://www.mql5.com/ru/code/8492
            tLots=Lots;
            ...
            break;}// #property strict (MQL5), original - https://www.mql5.com/ru/code/8492
        }
